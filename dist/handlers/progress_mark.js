...
let ProgressMarkHandler = (() => {
    let _classSuper = Handler;
    let _instanceExtraInitializers = [];
    let _post_decorators;
    return class ProgressMarkHandler extends _classSuper {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _post_decorators = [param('courseId', Types.String), param('lectureId', Types.String)];
        ...
        async post(domainId, courseId, lectureId) {
            requireLogin(this);
